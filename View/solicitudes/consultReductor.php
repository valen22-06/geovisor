...
<div class="card shadow-lg mt-5" id="card_red_man">
    ...
    <div class="row mb-3">
        <div class="col-md-4">
            <input type="text" name="buscarReductor" id="buscar" class="form-control" placeholder="Buscar por nombre o correo" 
                data-url='<?php echo getUrl("Solicitudes", "Solicitudes", "buscarReductor", false, "ajax"); ?>'>
        </div>
    </div>
        ...
        <table class="table table-hover table-striped">
            ...
            if(!empty($reductor)){
                foreach($reductor as $redu){
                    ...
                    echo "<td>";
                    echo"<form action='getUrl('Solicitudes', 'Solicitudes', 'postUpdateStatusReductor');' method='post' class='mt-4'>";
