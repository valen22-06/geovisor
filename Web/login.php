            ...
            <div class="card-body shadow-lg bg-light">
                ...
                <form class="mt-4" action="<?php echo getUrl('Acceso', 'Acceso', 'getCreate', false, 'ajax'); ?>" method="post">
                    ...
                    <div class="mb-3 m-4">
                        ...
                        <input type="text" class="form-control bg-light text-dark" name="user" id="documento" placeholder="Tu Documento"  />
                    </div>
                    <div class="mb-3 m-4">
                        <label for="clave" class="form-label text-dark"><b>Contraseña:</b></label>
                        <input type="password" class="form-control bg-light text-dark" name="pass" id="clave" placeholder="Tu Contraseña"  />
                    </div>
